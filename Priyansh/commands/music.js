...
module.exports.run = async function ({ api, event, args }) {
  let axios = require('axios');
    if (args.length == 0 || !args) return api.sendMessage('Tutiya ho ka gane ka nam to likho 🤐👈', event.threadID, event.messageID);
