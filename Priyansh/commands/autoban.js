...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `» Notice Send To My Owner Mr.Parfect «\n\n${c}, Tumhe Mene Ban Kr Diya Hai Kyu ki Aapne Mujhe Gali Di Hai 🥹`
	};
    //Add curse words without capital letters
	["Bot tutiya ", "bot mc", "Mc bot", "Chutiya bot", "Bsdk bot", "Bot teri maa ki chut", "Jhatu bot", "Rhaine bobo", "stupid bots", "chicken bot", "Bot lund", "Priyansh mc", "Mc parfect", "Bsdk @PARFECT 🖤🪽", "fuck bots", "@PARFECT 🖤🪽 chutiya", "@PARFECT 🖤🪽 gandu", "Gandu tera owner", "@PARFECT 🖤🪽 bc", "crazy bots", "Bot gandu", "Gandu bot", "bc @PARFECT 🖤🪽", "Nikal bsdk bot", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot cau"].forEach((a => {
