...
module.exports.run = async function({api, event, args, utils, Users, Threads}) {
    try {
        ...
        api.sendMessage({
            body: `╔═══❖••° °••❖═══╗\n     💝𝐖𝐄𝐋𝐂𝐎𝐌𝐄💝\n╚═══❖••° °••❖═══╝\n✨ Aapke Samne Aa Rhe Hai Group Ki Aan,Ban,San, ✦ ${name} ✦ Inke Liye Jordar Taliya 🤭😀\n\n\n💝 Humare Group Main Aapka Dil Se Suwagat hai ${name} 🙂\n        ✶⊶⊷⊷❍⊶⊷⊷✶\n\n\n 𝐌𝐚𝐝𝐞 𝐁𝐲: 𝐌𝐢𝐬𝐬..𝐏𝐫𝐢𝐲𝐚`,
        ...
        console.log(err);
        api.setMessageReaction('👎', event.messageID, (err) => {}, true);
        return api.sendMessage(`Kisi Ko Mantion Kr Tootiye 😐.`, event.threadID);
    }
};