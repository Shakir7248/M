...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("__shakirr__", 930, 540)
    ctx.fillText("__shakirr__", 930, 610)
    ctx.fillText("PARFECT 🖤🪽", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
