    ...
    case "reply":
      {
        if (arg[0] == "ban" || arg[0] == "Ban") {
          ...
          return api.sendMessage(`MERI OWNER MISS. PRIYA JI NE AAPKE GROUP KO PARMANENT BAN KR DIYA HAI UNBAN KRNE K LIYE MERI OWNER MISS. PRIYA SE CONTACT KRE 😊`, idgr, () =>
        ...
        if (arg[0] == "out" || arg[0] == "Out") {
          api.sendMessage(`»Notifications from Owner miss. Priya«\n\n ★★Deleted from chat★★ group`, idgr, () =>
            api.sendMessage(`${api.getCurrentUserID()}`, () =>
